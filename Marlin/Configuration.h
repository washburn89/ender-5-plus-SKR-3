...
#define STRING_CONFIG_H_AUTHOR "(Luke Washburn, E5P-SKR3 2.1.1)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.00, 80.00, 800.00, 441.45 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43.84, -3.28, -2.94 }
